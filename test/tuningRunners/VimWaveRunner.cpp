...
TEST_F(VimWaveRunner, twoVimRecordsAreCloserToEachOtherThanWithCiszejWave) {
	...
	double distance = getDistanceBetweenFiles(
			"test/wave/waveFiles/vim32bit_1.wav",
			"test/wave/waveFiles/ciszej32bit_1.wav");
	double distanceBetweenTheSameFiles = getDistanceBetweenFiles(
			"test/wave/waveFiles/vim32bit_1.wav",
			"test/wave/waveFiles/vim32bit_2.wav");
...
TEST_F(VimWaveRunner, scenario2) {
	...
	double distanceBetweenTheSameFiles = getDistanceBetweenFiles(
			"test/wave/waveFiles/vim32bit_1.wav",
			"test/wave/waveFiles/vim32bit_3.wav");
	std::cout << distance << std::endl;
	std::cout << distanceBetweenTheSameFiles << std::endl;
...
TEST_F(VimWaveRunner, scenario3) {
	...
	double distance = getDistanceBetweenFiles(
			"test/wave/waveFiles/vim32bit_1.wav",
			"test/wave/waveFiles/przegladarka32bit_1.wav");
	double distanceBetweenTheSameFiles = getDistanceBetweenFiles(
			"test/wave/waveFiles/vim32bit_1.wav",
			"test/wave/waveFiles/vim32bit_3.wav");
	std::cout << distance << std::endl;
...
TEST_F(VimWaveRunner, scenario4) {
	...
	//given
	double distanceBetweenTheSameFiles = getDistanceBetweenFiles(
			"test/wave/waveFiles/dziekuje32bit.wav",
			"test/wave/waveFiles/dziekuje32bitSmallNoise.wav");
	double distance = getDistanceBetweenFiles(
			"test/wave/waveFiles/dziekuje32bit.wav",
			"test/wave/waveFiles/dzienDobry32bit.wav");
	std::cout << distance << std::endl;
	std::cout << distanceBetweenTheSameFiles << std::endl;
...
TEST_F(VimWaveRunner, scenario5) {
	...
	double distanceBetweenTheSameFiles = getDistanceBetweenFiles(
			"test/wave/waveFiles/dziekuje32bit.wav",
			"test/wave/waveFiles/dziekuje32bitMediumNoise.wav");
	double distance = getDistanceBetweenFiles(
			"test/wave/waveFiles/dziekuje32bit.wav",
			"test/wave/waveFiles/dzienDobry32bit.wav");
	std::cout << distance << std::endl;
