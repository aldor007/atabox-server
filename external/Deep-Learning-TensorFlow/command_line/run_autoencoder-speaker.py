...
flags.DEFINE_integer('n_components', 1100, 1000, 3, 'Number of hidden units in the dae.')
...
if __name__ == '__main__':
    ...
    trX = load_from_np('train.npy')
    vlX = load_from_np('vtrain.npy')
    teX = load_from_np('train.npy')
    ...
    print('babcia', dae.reconstruct([np.load('babcia.npy')]))
    print('mama', dae.reconstruct([np.load('mama.npy')]))
    print('mrcin', dae.reconstruct([teX[0]]))
    print('mrcin', dae.reconstruct([teX[1]]))
