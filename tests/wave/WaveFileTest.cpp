...
TEST_F(WaveFileTest, doesntThrowExceptionWhenFileExists) {
	ASSERT_NO_THROW(WaveFile("tests/wave/waveFiles/bells.wav"));
}

TEST_F(WaveFileTest, readsChunkIDCorrectly) {
	WaveFile waveFile("tests/wave/waveFiles/bells.wav");
...
TEST_F(WaveFileTest, readsDataCorrectlyFor8Bits) {
	WaveFile waveFile("tests/wave/waveFiles/8bitSilence.wav");
...
TEST_F(WaveFileTest, readsDataCorrectlyForMoreThan8Bits) {
	WaveFile waveFile("tests/wave/waveFiles/32bitSilence.wav");
...
TEST_F(WaveFileTest, lastSampleMachesEndOfFile) {
	WaveFile waveFile("tests/wave/waveFiles/8bitSilenceWithTenAtTheEnd.wav");
