...
CPP_SRCS += \
../test/wave/processing/ProcessorTest.cpp 

OBJS += \
./test/wave/processing/ProcessorTest.o 

CPP_DEPS += \
./test/wave/processing/ProcessorTest.d 


# Each subdirectory must supply rules for building sources it contributes
test/wave/processing/%.o: ../test/wave/processing/%.cpp
	@echo 'Building file: $<'
