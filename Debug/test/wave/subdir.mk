...
test/wave/%.o: ../test/wave/%.cpp
	...
	g++ -std=c++0x -D__GXX_EXPERIMENTAL_CXX0X__ -I"/home/mj/CppWorkspace/Atabox_server/src" -I"/home/mj/CppWorkspace/Atabox_server/external" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
